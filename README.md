...
Preview screenshots are hosted in [issue #1](https://github.com/patlux/pi-chatgpt-limit/issues/1) so they are not downloaded when installing this pi package.
